// ==UserScript==
// @name        GCHiddenText Redux - mdawaffe
// @author      mdawaffe
// @namespace   https://github.com/mdawaffe/userscripts/
// @description Display "hidden text" or "HTML Comments".
// @include	    https://www.geocaching.com/geocache/*
// @version     3.0.0.mdawaffe
// ==/UserScript==

// Originally: https://greasyfork.org/en/scripts/5378-gchiddentext-redux by https://greasyfork.org/en/users/5697-cryo99
...
if(found){
  ...
  showbutton.style.paddingRight = "5px";
	...
	//Insert Button
	var phonebutton = document.getElementById('ctl00_ContentBody_btnSendToGPS');
    phonebutton.style.marginRight = '0px';
