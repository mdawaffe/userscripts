// ==UserScript==
// @name           GC Track Show All
// @namespace      https://github.com/mdawaffe/userscripts/
// @author         mdawaffe
// @description    Lists on a single page all trackables from a search result
// @include        https://www.geocaching.com/track/search.*
// @require        https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js
// @version        0.0.1
// ==/UserScript==

var form = jQuery( '#aspnetForm' );
var table = jQuery( 'table.Table tbody' );
...
var d = 199; // Max of 200 pages (the original one and the 199 AJAX loaded ones).
function parseResponse( response ) {
	...
	table.append( newPage.find( 'table.Table tr' ) );
