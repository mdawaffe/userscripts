...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(168);
	...
	var dispatcher = (0, _redux.createDispatcher)(store, [logger]);
	var redux = (0, _redux.createRedux)(dispatcher);
	
	var google = undefined;
	
	var app = _react2['default'].render(_react2['default'].createElement((0, _containersApp2['default'])(redux), { authorize: function authorize() {
			google.authorize();
		} }), document.getElementById('app'));
	
	google = new _google2['default'](CLIENT_ID, SCOPES, {
		needAuth: function needAuth(result) {
			redux.dispatch(actions.setPhaseToReady());
			redux.dispatch(actions.failUser(result.error || ""));
		},
	
		hasAuth: function hasAuth(user) {
		...
		loaded: function loaded(list, file) {
			...
			function syncer(dispatch) {
				var debug = (0, _debug2['default'])('user-scripts-data:sync');
				...
				return function (action) {
					...
					switch (action.type) {
						case constants.ITEM_ADD:
							var addIndex = listIndexOf(action.data.url);
							if (~addIndex) {
						...
						case constants.ITEM_MARK_AS_UNDONE:
							var markIndex = listIndexOf(action.data.url);
							if (~markIndex) {
								var item = _extends({}, action.data, { done: action.type === constants.ITEM_MARK_AS_DONE });
			...
			redux.replaceDispatcher((0, _redux.createDispatcher)(store, [logger, syncer]));
	...
	function itemSet(event) {
		for (var i = 0, l = event.newValues.length; i < l; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewareThunk = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxReact = __webpack_require__(169);
	
	var _UserScriptDataApp = __webpack_require__(182);
	
	var _UserScriptDataApp2 = _interopRequireDefault(_UserScriptDataApp);
	
	exports['default'] = function (redux) {
			...
			_createClass(App, [{
				...
				value: function render() {
					...
					return _react2['default'].createElement(
						...
						{ redux: redux },
						function () {
							return _react2['default'].createElement(_UserScriptDataApp2['default'], { authorize: authorize });
						}
					);
				}
			}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libReact = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(172);
	
	var _createProvider2 = _interopRequireDefault(_createProvider);
	
	var _createProvideDecorator = __webpack_require__(173);
	
	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);
	
	var _createConnector = __webpack_require__(175);
	
	var _createConnector2 = _interopRequireDefault(_createConnector);
	
	var _createConnectDecorator = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIdentity = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAuth = __webpack_require__(185);
	
	var _componentsAuth2 = _interopRequireDefault(_componentsAuth);
	
	var _componentsItemForm = __webpack_require__(186);
	
	var _componentsItemForm2 = _interopRequireDefault(_componentsItemForm);
	
	var _componentsItemList = __webpack_require__(187);
	...
	var UserScriptDataApp = (function (_React$Component) {
		...
		function UserScriptDataApp() {
			_classCallCheck(this, _UserScriptDataApp);
	
			_get(Object.getPrototypeOf(_UserScriptDataApp.prototype), 'constructor', this).apply(this, arguments);
		}
	
		_createClass(UserScriptDataApp, [{
			key: 'render',
			value: function render() {
				...
				if (!user) {
					return _react2['default'].createElement(_componentsAuth2['default'], _extends({ authorize: authorize }, (0, _redux.bindActionCreators)(actions, dispatch)));
				}
		...
		var _UserScriptDataApp = UserScriptDataApp;
		UserScriptDataApp = (0, _reduxReact.connect)(function (state) {
			return {
				items: state.items,
				user: state.user,
				phase: state.phase,
	...
	exports['default'] = UserScriptDataApp;
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	var ITEM_DELETE = 'ITEM_REMOVE';
	exports.ITEM_DELETE = ITEM_DELETE;
	var ITEM_MARK_AS_DONE = 'ITEM_MARK_AS_DONE';
	exports.ITEM_MARK_AS_DONE = ITEM_MARK_AS_DONE;
	var ITEM_MARK_AS_UNDONE = 'ITEM_MARK_AS_UNDONE';
	
	exports.ITEM_MARK_AS_UNDONE = ITEM_MARK_AS_UNDONE;
	var USER_SET = 'USER_SET';
	exports.USER_SET = USER_SET;
	var USER_FAIL = 'USER_FAIL';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.markItemAsDone = markItemAsDone;
	exports.markItemAsUndone = markItemAsUndone;
	...
	function addItem(item) {
		var source = arguments.length <= 1 || arguments[1] === undefined ? 'local' : arguments[1];
	...
	function markItemAsUndone(item) {
		var source = arguments.length <= 1 || arguments[1] === undefined ? 'local' : arguments[1];
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							_react2["default"].createElement(
								"td",
								null,
								_react2["default"].createElement("input", { id: "datetime", name: "datetime", type: "datetime-local" })
							)
						),
						_react2["default"].createElement(
							"tr",
							...
							_react2["default"].createElement(
								"td",
								null,
								_react2["default"].createElement("input", { id: "title", name: "title", type: "text" })
							)
						),
						_react2["default"].createElement(
							"tr",
...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
		...
		var _stringCompare = function _stringCompare(a, b) {
			if (a < b) {
				return -1;
			} else if (a > b) {
				return 1;
	...
	var ItemList = (function (_React$Component) {
		...
		function ItemList(props) {
			...
			_get(Object.getPrototypeOf(ItemList.prototype), 'constructor', this).call(this, props);
		...
		_createClass(ItemList, [{
			...
			value: function comparator(a, b) {
				var _state$sortMethod$split = this.state.sortMethod.split(".");
	
				var _state$sortMethod$split2 = _slicedToArray(_state$sortMethod$split, 2);
	
				var method = _state$sortMethod$split2[0];
				var directionKey = _state$sortMethod$split2[1];
	
				var direction = directionKey === "asc" ? 1 : -1;
			...
			key: 'sortList',
			value: function sortList(method, event) {
				event.preventDefault();
			...
			value: function render() {
				...
				var markItemAsDone = _props.markItemAsDone;
				var markItemAsUndone = _props.markItemAsUndone;
				...
				var sorted = [].concat(_toConsumableArray(items));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function items(state, action) {
		...
		switch (action.type) {
			case _constants.ITEM_ADD:
				return [].concat(_toConsumableArray(state.filter(function (item) {
					return item.url !== action.data.url;
				})), [action.data]);
			case _constants.ITEM_DELETE:
				return [].concat(_toConsumableArray(state.filter(function (item) {
					return item.url !== action.data.url;
				})));
			case _constants.ITEM_MARK_AS_DONE:
				return [].concat(_toConsumableArray(state.map(function (item) {
					if (item.url === action.data.url) {
						return _extends({}, item, { done: true });
					}
					return item;
				})));
			case _constants.ITEM_MARK_AS_UNDONE:
				return [].concat(_toConsumableArray(state.map(function (item) {
					if (item.url === action.data.url) {
						return _extends({}, item, { done: false });
					}
					return item;
				})));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function user(state, action) {
		...
		switch (action.type) {
			case _constants.USER_SET:
				return action.data;
			case _constants.USER_FAIL:
				return false;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function phase(state, action) {
		if (state === undefined) state = _constants.PHASE_LOADING;
	
		switch (action.type) {
			case _constants.PHASE_READY:
				return _constants.PHASE_READY;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = (0, _debug2['default'])('user-scripts-data:google');
	
	function Google(client_id, scopes, callbacks) {
